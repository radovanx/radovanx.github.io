import{h as m,s as g,a as f}from"./ai-engine.DxJ7nNiN.js";const l="ai-article-chat";document.addEventListener("astro:page-load",v);function v(){const s=document.querySelector(".prose");if(!s||!m())return;document.getElementById(l)?.remove();const e=document.createElement("div");e.id=l,e.className="ai-chat",e.innerHTML=`
