import{h as g,s as f,a as v,f as y}from"./ai-engine.CcK6lLP7.js";const l="ai-article-chat";d();document.addEventListener("astro:page-load",d);function d(){const n=document.querySelector(".prose");if(!n||!g())return;document.getElementById(l)?.remove();const e=document.createElement("div");e.id=l,e.className="ai-chat",e.innerHTML=`
